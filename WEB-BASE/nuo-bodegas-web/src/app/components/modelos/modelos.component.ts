...
export class ModelosComponent implements OnInit {
  ...
  titulo='Modelos';
  constructor(private _modelosServiice: ModelosService, private router:Router) { }
  ...
  ngOnInit() {
    this._modelosServiice.devuelveListaModelos().subscribe(datos=>this.asignarModelos(datos))
  }
