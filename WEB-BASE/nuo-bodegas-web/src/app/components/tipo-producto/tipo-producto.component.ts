...
export class TipoProductoComponent implements OnInit {
  ...
  constructor(private _tipoProductoService: TipoProductoService, private router:Router) { }
  ...
  ngOnInit() {
    this._tipoProductoService.obtenerTipos().subscribe(datos => this.asignarTipo(datos) , error=>console.log(error));
