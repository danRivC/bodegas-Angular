...
import { PaginaPerfil } from 'src/app/components/pagina/models/pagina-perfil.model';
import { PaginaResponse } from 'src/app/components/pagina/models/pagina-response.model';
...
export class PerfilFormularioComponent implements OnInit, OnChanges, OnDestroy {
  ...
  constructor(private router:Router ,private formBuilder: FormBuilder, private _location: Location, private perfilService: PerfilService, private _snackBar: MatSnackBar, private _router:Router) {
    this.buildForm();
