...
export class ProductoComponent implements OnInit {
  titulo='Productos'
  constructor(private _productoService: ProductoService, private router:Router, public dialog: MatDialog) { }
  ...
  ngOnInit() {
    this._productoService.obtenerProductos().subscribe(datos=>this.asignarProductos(datos), error=>console.log(error));
